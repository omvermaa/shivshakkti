...
export default function LoginPage() {
  ...
  const handleGoogleLogin = async () => {
    setIsLoading(true);
    // callbackUrl will automatically send them back to the admin dashboard
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <Card className="bg-zinc-900 border-zinc-800 shadow-2xl shadow-black/50">
          ...
          <CardContent className="space-y-4">
            ...
            {/* Standard Email Login (Visual placeholder if you add CredentialsProvider later) */}
            <div className="space-y-2">
              ...
              <Input 
                ...
                className="bg-zinc-950 border-zinc-800 text-zinc-100 focus-visible:ring-purple-500/50"
              />
            </div>
            <div className="space-y-2">
