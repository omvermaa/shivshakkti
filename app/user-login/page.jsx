...
export default function UserLoginPage() {
  ...
  const handleGoogleLogin = async () => {
    setIsLoading(true);
    // Customers are sent back to the shop after logging in
  ...
  return (
    <div className="min-h-screen bg-zinc-950 flex flex-col justify-center items-center p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md relative z-10">
        <Link href="/shop" className="inline-flex items-center text-sm text-zinc-400 hover:text-purple-400 mb-6 transition-colors">
        ...
        <Card className="bg-zinc-900 border-zinc-800 shadow-2xl shadow-black/50">
          <CardHeader className="space-y-1 text-center pb-6">
            ...
            <CardTitle className="text-2xl font-bold tracking-tight text-zinc-100">
              Welcome to Shiv Shakkti
            </CardTitle>
            <CardDescription className="text-zinc-400">
              Sign in to save your cart and view your orders
            </CardDescription>
          </CardHeader>
          <CardContent>
            <Button 
