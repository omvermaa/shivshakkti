...
// import { LayoutDashboard, Package, ShoppingCart, Home, Menu } from "lucide-react";
...
//         <Link href="/" className="text-zinc-500 hover:text-purple-400 transition-colors" title="Back to Store">
...
//               <button className="text-zinc-300 hover:text-white transition-colors p-1">
...
//       {/* --- MAIN CONTENT AREA --- */}
//       {/* Reduced padding on mobile (p-4) vs desktop (lg:p-10) to give tables more room to breathe */}
...
import { LayoutDashboard, Package, ShoppingCart, Home, Menu, X } from "lucide-react";
import { Sheet, SheetContent, SheetTrigger } from "../components/ui/sheet";
