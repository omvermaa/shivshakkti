    ...
    <div className="min-h-screen bg-zinc-950 flex text-zinc-50">
      ...
      <aside className="w-64 bg-zinc-900 border-r border-zinc-800 hidden md:flex flex-col">
        ...
        <nav className="flex-1 py-6 px-4 space-y-2">
          ...
          <Link href="/admin/orders" className="flex items-center px-4 py-3 text-sm font-medium rounded-lg text-zinc-400 hover:text-zinc-100 hover:bg-zinc-800 transition-colors">
